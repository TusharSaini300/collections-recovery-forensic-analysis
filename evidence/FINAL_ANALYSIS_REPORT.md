...
### Direct 11% claim bridge

The reported ~11% can be reproduced for **February → March gross recovery**:

- February: **₹17.01 Cr**
- March: **₹18.89 Cr**
- MoM change: **+11.03%**

A second plausible KPI definition, corrected recovery/account, moves from **₹5,618 to ₹6,277 (+11.73%)** over the same month pair. Because the supplied brief does not specify the leadership numerator, denominator, attribution rule or window, the exact source of the reported 11% remains **UNVERIFIED**.

This does not establish sustained improvement. Across complete Jan–Jul months, gross recovery has no significant linear trend (**p≈0.89**), while population-aligned, mix-standardized and fixed-cohort checks are effectively flat.
