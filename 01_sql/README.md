...
The reported ~11% can be reproduced as a Feb→Mar gross-recovery increase of **11.03%** (₹17.01 Cr → ₹18.89 Cr). Corrected recovery/account also rises **11.73%** over Feb→Mar. Because the brief does not disclose the exact leadership numerator, denominator, attribution rule or window, the repository treats the precise claim definition as **UNVERIFIED** rather than assuming one.
